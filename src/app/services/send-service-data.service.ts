...
export class SendServiceDataService {
  ...
  sendPost(send_data: any, form_id: string): Observable<any> {
    const urlstring = API_server_url + 'services/forms/insert.php?key=' +  GenerateURLtokenService.getKey() + '&form_id=' + form_id + '&lang=' + Strings.lang;
  ...
  getFormElements(form_id: string): Observable<any>{
    const urlstring = API_server_url + 'services/forms/?key=' + GenerateURLtokenService.getKey() + "&form_id=" + form_id + '&lang=' + Strings.lang;
    console.log(urlstring);
    return this.http.get(urlstring);
  }
  getNotification(): Observable<any>{
    const urlstring = API_server_url + 'notification/?key=' + GenerateURLtokenService.getKey() +'&user_id='+Strings.user_id + '&lang=' + Strings.lang;
    console.log(urlstring);
    return this.http.get<any[]>(urlstring);
  }
  getServices(): Observable<any>{
    const urlstring = API_server_url + 'services/get/?key=' + GenerateURLtokenService.getKey() + '&lang=' + Strings.lang;
    console.log(urlstring);
    return this.http.get(urlstring)
  }
  getUMKD(): Observable<any>{
    const urlstring = API_server_url + 'document/umkd/?key=' + GenerateURLtokenService.getKey() + "&iin=" + Strings.iin + '&lang=' + Strings.lang;
    console.log(urlstring);
    return this.http.get(urlstring)
  }
  getNotificationForId(id): Observable<any>{
    const urlstring = API_server_url + 'notification/details/?key=' + GenerateURLtokenService.getKey() + '&notification_id=' + id + '&lang=' + Strings.lang;
    console.log(urlstring);
    return this.http.get<any[]>(urlstring);
  }
  setNotificationStatusRead(id: string): Observable<any>{
    const urlstring = API_server_url + 'notification/update.php/?key=' + GenerateURLtokenService.getKey() + '&lang=' + Strings.lang;
    console.log(urlstring);
